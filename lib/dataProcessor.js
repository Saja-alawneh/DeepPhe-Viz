...
let newEntry = {};
let labelData={};
for (var key in CountsPerYearAndQuarter ) // loop for the year
{
    for (var key1 in CountsPerYearAndQuarter[key]) // loop for the months
    {
        for (var key2 in CountsPerYearAndQuarter[key][key1]) //iterate through the Labels 
        {  
