...
class DataProcessor {
    ...
    //***************************************************************** */
    //New Function TermLabel Summary getTermsLabelSummary Saja Al

    static getTermsLabelSummary(patientIds, neo4jRawArr) {
        let self = this;
        let termInfo = {};
    ...
    //***************************************************************** */
    //New Function Document Summary getDocTermSummary Saja Al-alawneh
    static getDocTermSummary(patientIds, neo4jRawArr) {
        let self = this;
        let docInfo = {};
       // docInfo.doc = _.sortBy(neo4jRawArr, 'documentDate');
        docInfo.label = [];
        docInfo.data = [];
